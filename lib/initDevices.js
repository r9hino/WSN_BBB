    ...
    for(var devId in jsonWSN){
        ...
        // If device is connected to an xbee module:
            ...
            if(jsonWSN[devId].switchValue === 1) 
                xbee.remoteATCmdReq(jsonWSN[devId].xbee, null, 'D4', xbee.C.PIN_MODE.D4.DIGITAL_OUTPUT_HIGH);
            else 
                xbee.remoteATCmdReq(jsonWSN[devId].xbee, null, 'D4', xbee.C.PIN_MODE.D4.DIGITAL_OUTPUT_LOW);
