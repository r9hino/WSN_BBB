    ...
    switch(frame.commandStatus){
        case 0x00:
            if (typeof(cmdData) !== "undefined" && cmdData !== null && cmdData.length > 0)
                console.log("Coordinator - " + cmd + " AT Command Response: Ok. " + "Command Data: [" + cmdData + "]");
            else
                console.log("Coordinator - " + cmd + " AT Command Response: Ok.");
            break;
        case 0x01:
            console.log("Coordinator - " + cmd + " AT Command Response: Error.");
            break;
        case 0x02:
            console.log("Coordinator - " + cmd + " AT Command Response: Invalid command.");
            break;
        case 0x03:
            console.log("Coordinator - " + cmd + " AT Command Response: Invalid parameter.");
            break;
        case 0x04:
            console.log("Coordinator - " + cmd + " AT Command Response: Tx failure.");
            break;
    }
};
