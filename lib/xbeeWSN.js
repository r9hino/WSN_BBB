...
xbee.prototype.getXbeeWSNInfo = function(){
    //console.log(addrXbee64);
    //console.log("Xbee's 16 bit addresses: " + addrXbee16);
    //console.log('Routes: ', networkRoutes);
    xbeeWSNStateObj = {"addrXbee64": addrXbee64, "addrXbee16": addrXbee16, "networkRoutes": networkRoutes};
    return xbeeWSNStateObj;
}
...
xbee.prototype.routeRecordIndicator = function(frame){
    //console.log(frame);
    var xbeeKey = this.getXbeeKeyByAddress64(frame.remote64);
    // array 16bit addresses -> array xbee key
    var hopsAddresses = frame.hopsAddresses.map(this.getXbeeKeyByAddress16);
